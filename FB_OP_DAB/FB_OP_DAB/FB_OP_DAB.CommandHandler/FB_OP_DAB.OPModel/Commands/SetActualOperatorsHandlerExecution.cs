...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class SetActualOperatorsHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return SetActualOperatorsHandler((SetActualOperators)command);
        }
        ...
        {
            return typeof(SetActualOperators);
        }
    }
}
