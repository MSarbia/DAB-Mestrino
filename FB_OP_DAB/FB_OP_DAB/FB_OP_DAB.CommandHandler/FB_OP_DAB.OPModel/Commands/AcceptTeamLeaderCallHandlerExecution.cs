...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class AcceptTeamLeaderCallHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return AcceptTeamLeaderCallHandler((AcceptTeamLeaderCall)command);
        }
        ...
        {
            return typeof(AcceptTeamLeaderCall);
        }
    }
}
