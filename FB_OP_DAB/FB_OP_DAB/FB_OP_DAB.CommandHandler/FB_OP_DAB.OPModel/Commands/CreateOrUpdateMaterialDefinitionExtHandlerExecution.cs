...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class CreateOrUpdateMaterialDefinitionExtHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return CreateOrUpdateMaterialDefinitionExtHandler((CreateOrUpdateMaterialDefinitionExt)command);
        }
        ...
        {
            return typeof(CreateOrUpdateMaterialDefinitionExt);
        }
    }
}
