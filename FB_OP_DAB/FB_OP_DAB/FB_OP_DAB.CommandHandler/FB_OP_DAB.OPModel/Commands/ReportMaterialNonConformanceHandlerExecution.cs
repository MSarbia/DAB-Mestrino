...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ReportMaterialNonConformanceHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ReportMaterialNonConformanceHandler((ReportMaterialNonConformance)command);
        }
        ...
        {
            return typeof(ReportMaterialNonConformance);
        }
    }
}
