...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class FireUpdateAndonEventHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return FireUpdateAndonEventHandler((FireUpdateAndonEvent)command);
        }
        ...
        {
            return typeof(FireUpdateAndonEvent);
        }
    }
}
