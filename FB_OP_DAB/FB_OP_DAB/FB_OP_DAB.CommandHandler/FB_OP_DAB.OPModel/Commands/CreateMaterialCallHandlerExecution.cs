...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class CreateMaterialCallHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return CreateMaterialCallHandler((CreateMaterialCall)command);
        }
        ...
        {
            return typeof(CreateMaterialCall);
        }
    }
}
