...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class CreateWorkOrderExtHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return CreateWorkOrderExtHandler((CreateWorkOrderExt)command);
        }
        ...
        {
            return typeof(CreateWorkOrderExt);
        }
    }
}
