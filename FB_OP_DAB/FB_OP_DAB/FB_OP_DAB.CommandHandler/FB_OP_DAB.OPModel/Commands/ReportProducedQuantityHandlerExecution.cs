...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ReportProducedQuantityHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ReportProducedQuantityHandler((ReportProducedQuantity)command);
        }
        ...
        {
            return typeof(ReportProducedQuantity);
        }
    }
}
