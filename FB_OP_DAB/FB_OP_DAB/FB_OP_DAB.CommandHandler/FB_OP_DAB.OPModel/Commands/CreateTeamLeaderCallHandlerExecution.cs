...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class CreateTeamLeaderCallHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return CreateTeamLeaderCallHandler((CreateTeamLeaderCall)command);
        }
        ...
        {
            return typeof(CreateTeamLeaderCall);
        }
    }
}
