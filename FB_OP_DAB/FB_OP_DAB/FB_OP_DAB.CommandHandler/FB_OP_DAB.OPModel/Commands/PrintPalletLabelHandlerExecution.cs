...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class PrintPalletLabelHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return PrintPalletLabelHandler((PrintPalletLabel)command);
        }
        ...
        {
            return typeof(PrintPalletLabel);
        }
    }
}
