...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ReportOperationProgressHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ReportOperationProgressHandler((ReportOperationProgress)command);
        }
        ...
        {
            return typeof(ReportOperationProgress);
        }
    }
}
