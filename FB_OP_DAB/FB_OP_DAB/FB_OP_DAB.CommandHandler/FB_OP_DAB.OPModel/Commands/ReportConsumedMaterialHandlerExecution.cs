...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ReportConsumedMaterialHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ReportConsumedMaterialHandler((ReportConsumedMaterial)command);
        }
        ...
        {
            return typeof(ReportConsumedMaterial);
        }
    }
}
