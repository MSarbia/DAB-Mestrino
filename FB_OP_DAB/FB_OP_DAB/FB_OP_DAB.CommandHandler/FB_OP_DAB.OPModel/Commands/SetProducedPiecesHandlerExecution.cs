...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class SetProducedPiecesHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return SetProducedPiecesHandler((SetProducedPieces)command);
        }
        ...
        {
            return typeof(SetProducedPieces);
        }
    }
}
