...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class CreateToBeConsumedMaterialExtHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return CreateToBeConsumedMaterialExtHandler((CreateToBeConsumedMaterialExt)command);
        }
        ...
        {
            return typeof(CreateToBeConsumedMaterialExt);
        }
    }
}
