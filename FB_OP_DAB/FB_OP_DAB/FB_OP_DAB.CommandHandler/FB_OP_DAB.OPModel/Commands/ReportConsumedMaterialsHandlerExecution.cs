...
namespace Engineering.DAB.OperationalData.FB_OP_DAB.OPModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ReportConsumedMaterialsHandlerShell : ICommandHandler
    {
        ...
        public Response Execute(IUnifiedSdk unifiedSdk, ICommand command)
        {
            ...
            return ReportConsumedMaterialsHandler((ReportConsumedMaterials)command);
        }
        ...
        {
            return typeof(ReportConsumedMaterials);
        }
    }
}
