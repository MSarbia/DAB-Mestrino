...
namespace Engineering.DAB.AppDAB.AppDAB.DPPOMModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class GetOEEEfficiencyHandlerShell : ICompositeCommandHandler
    {
        ...
        public Response Execute(IUnifiedSdkComposite unifiedSdkcomposite, ICommand command)
        {
            ...
            return GetOEEEfficiencyHandler((GetOEEEfficiency)command);
        }
        ...
        {
            return typeof(GetOEEEfficiency);
        }
    }
}
