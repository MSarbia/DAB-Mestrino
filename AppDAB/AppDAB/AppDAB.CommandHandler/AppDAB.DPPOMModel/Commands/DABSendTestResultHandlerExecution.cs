...
namespace Engineering.DAB.AppDAB.AppDAB.DPPOMModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class DABSendTestResultHandlerShell : ICompositeCommandHandler
    {
        ...
        public Response Execute(IUnifiedSdkComposite unifiedSdkcomposite, ICommand command)
        {
            ...
            return DABSendTestResultHandler((DABSendTestResult)command);
        }
        ...
        {
            return typeof(DABSendTestResult);
        }
    }
}
