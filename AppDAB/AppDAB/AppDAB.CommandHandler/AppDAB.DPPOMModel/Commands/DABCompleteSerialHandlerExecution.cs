...
namespace Engineering.DAB.AppDAB.AppDAB.DPPOMModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class DABCompleteSerialHandlerShell : ICompositeCommandHandler
    {
        ...
        public Response Execute(IUnifiedSdkComposite unifiedSdkcomposite, ICommand command)
        {
            ...
            return DABCompleteSerialHandler((DABCompleteSerial)command);
        }
        ...
        {
            return typeof(DABCompleteSerial);
        }
    }
}
