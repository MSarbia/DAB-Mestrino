...
namespace Engineering.DAB.AppDAB.AppDAB.DPPOMModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class DABAcceptMaterialCallHandlerShell : ICompositeCommandHandler
    {
        ...
        public Response Execute(IUnifiedSdkComposite unifiedSdkcomposite, ICommand command)
        {
            ...
            return DABAcceptMaterialCallHandler((DABAcceptMaterialCall)command);
        }
        ...
        {
            return typeof(DABAcceptMaterialCall);
        }
    }
}
