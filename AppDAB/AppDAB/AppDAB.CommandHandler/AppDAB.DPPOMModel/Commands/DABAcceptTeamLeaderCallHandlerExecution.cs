...
namespace Engineering.DAB.AppDAB.AppDAB.DPPOMModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class DABAcceptTeamLeaderCallHandlerShell : ICompositeCommandHandler
    {
        ...
        public Response Execute(IUnifiedSdkComposite unifiedSdkcomposite, ICommand command)
        {
            ...
            return DABAcceptTeamLeaderCallHandler((DABAcceptTeamLeaderCall)command);
        }
        ...
        {
            return typeof(DABAcceptTeamLeaderCall);
        }
    }
}
