...
namespace Engineering.DAB.AppDAB.AppDAB.DPPOMModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class DABCreateMaterialCallHandlerShell : ICompositeCommandHandler
    {
        ...
        public Response Execute(IUnifiedSdkComposite unifiedSdkcomposite, ICommand command)
        {
            ...
            return DABCreateMaterialCallHandler((DABCreateMaterialCall)command);
        }
        ...
        {
            return typeof(DABCreateMaterialCall);
        }
    }
}
