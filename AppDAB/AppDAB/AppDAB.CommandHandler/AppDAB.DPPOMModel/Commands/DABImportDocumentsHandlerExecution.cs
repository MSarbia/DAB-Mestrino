...
namespace Engineering.DAB.AppDAB.AppDAB.DPPOMModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class DABImportDocumentsHandlerShell : ICompositeCommandHandler
    {
        ...
        public Response Execute(IUnifiedSdkComposite unifiedSdkcomposite, ICommand command)
        {
            ...
            return DABImportDocumentsHandler((DABImportDocuments)command);
        }
        ...
        {
            return typeof(DABImportDocuments);
        }
    }
}
