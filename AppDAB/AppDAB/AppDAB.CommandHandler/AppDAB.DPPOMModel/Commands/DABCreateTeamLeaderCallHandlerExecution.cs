...
namespace Engineering.DAB.AppDAB.AppDAB.DPPOMModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class DABCreateTeamLeaderCallHandlerShell : ICompositeCommandHandler
    {
        ...
        public Response Execute(IUnifiedSdkComposite unifiedSdkcomposite, ICommand command)
        {
            ...
            return DABCreateTeamLeaderCallHandler((DABCreateTeamLeaderCall)command);
        }
        ...
        {
            return typeof(DABCreateTeamLeaderCall);
        }
    }
}
