...
using System.IO;
using Siemens.SimaticIT.U4DM.MasterData.FB_MS_BOP.MSModel.Types;
...
namespace Engineering.DAB.AppDAB.AppDAB.DPPOMModel.Commands
{
    ...
    public partial class DABImportDocumentsHandlerShell
    {
        ...
        {
            var extension = filename.Split('.').LastOrDefault().ToLowerInvariant();
            ...
            extension = "." + extension;
            string mime;
            return _mappings.TryGetValue(extension, out mime) ? mime : "application/pdf";
        }
    }
}
