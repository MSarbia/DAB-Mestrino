...
namespace Engineering.DAB.AppDAB.AppDAB.DPPOMModel.Commands
{
    ...
    /// Class initialize
    /// </summary>
    public partial class ImportMaterialDefinitionHandlerShell : ICompositeCommandHandler
    {
        ...
        public Response Execute(IUnifiedSdkComposite unifiedSdkcomposite, ICommand command)
        {
            ...
            return ImportMaterialDefinitionHandler((ImportMaterialDefinition)command);
        }
        ...
        {
            return typeof(ImportMaterialDefinition);
        }
    }
}
