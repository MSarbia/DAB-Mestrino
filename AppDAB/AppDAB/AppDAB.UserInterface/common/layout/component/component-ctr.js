(function () {
    'use strict';
    ComponentController.$inject = ['$timeout', '$window', '$rootScope', '$scope', 'common.services.component.swacComponentManager', 'common.services.component.uiComponentService', 'componentManifest'];
