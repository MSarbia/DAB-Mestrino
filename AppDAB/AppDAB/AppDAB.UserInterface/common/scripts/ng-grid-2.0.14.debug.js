...
(function (window, $) {
    ...
    ngAggregate.prototype.aggClass = function () {
        // © Siemens AG, 2014
        return "uyAggArrow " + (this.collapsed ? "fa fa-chevron-right" : "fa fa-chevron-down");
    };
          ...
          "<div id=\"group-header-container\" ng-style=\"rowStyle(row)\" style=\"overflow:hidden;\"; class=\"ngAggregate\">\r" +
            ...
            "\n" +
                "<div id=\"group-check-container\" style=\"display:table-cell; vertical-align:middle; height:inherit;\">\r" +
                    "<div style=\"line-height:1em\"><input type=\"checkbox\" style=\"margin: 0 10px 0 2px; cursor: pointer\" ng-checked=\"row.getCheckState();\" /></div>\r" +
                "\n" +
                "</div>\r" +
            "\n" +
            "</div>\r" +
