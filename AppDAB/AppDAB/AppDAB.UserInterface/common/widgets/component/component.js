...
(function () {
     ...
     * @param {string} sit-source If the component type is SWAC, the source should contain the URL of the SWAC component. If the component type is UI, the source is the directive name of the component.
    ...
    ComponentDir.$inject = ['$rootScope', 'common.services.component.swacContainerService', 'common.services.component.swacComponentService', 'common.services.component.uiComponentService', '$timeout', 'common.services.logger.service', '$compile'];
    function ComponentDir($rootScope, swacContainerService, swacComponentService, uiComponentService, $timeout, logger, $compile) {
        ...
        function compile(element, attributes) {
            ...
            function onReadySwac(name, component) {
                //console.info('sit-container - on ready swac......:' + name + '.....' + componentController.compName);
            ...
            function pre(scope, element, attributes, controllers) {
                ...
                if ('swac' === componentController.type) {
                    ...
                    swacComponentService.loadComponent(componentController.compName, '', componentController.source, container[0], 0, 0, '100%', '100%', componentController.flavor);
                    return;
                }
                var uiComponentTag = '<' + componentController.source + ' sit-internal="{{ComponentCtrl.scopeid}}" name="{{ComponentCtrl.compName}}" ';
            ...
            function post(scope, element) {
                if (attributes.gridMaxColumns !== undefined) {
                    ...
                    var __height = (gridBoxheight * parseInt(componentController.rows)) - attributes.gridMargin;
                    //element.parent().width() / attributes.gridMaxColumns;    // gridster width
    ...
    ComponentController.$inject = ['$rootScope', '$scope', '$element', '$timeout', 'common.services.component.swacContainerService', 'common.services.component.swacComponentService', 'common.services.component.uiComponentService'];
    function ComponentController($rootScope, $scope, $element, $timeout, swacContainerService, swacComponentService, uiComponentService) {
        var vm = this;
        ...
        function prepareComponentStyle() {
            vm.componentStyle = {
                position: 'absolute',
                width: vm.cols * vm.cellWidth + 'px',
                height: vm.rows * vm.cellHeight + 'px',
                left: vm.left * vm.cellWidth + 'px',
                top: vm.top * vm.cellHeight + 'px',
                overflow: 'auto'
            };
        }
    ...
    */
    function UIComponentInstance(id, name, type, contracts, componentController, $rootScope) {
        var self = this;
        var _id, _name, _type, _contracts, _controller, _$rootScope;
...
(function () {
    ...
    ContainerDirective.$inject = ['common.services.component.swacContainerService', 'common.services.component.uiComponentService', '$window', '$location', '$timeout', 'common.services.logger.service', 'common.services.umc'];
    function ContainerDirective(swacContainerService, uiComponentService, $window, $location, $timeout, logger, umcService) {
        ...
        function compile(element, attributes) {
            ...
            function onResize(height, width) {
                ...
                scope.$broadcast('sit-container.cellSizeChanged', { "height": controller.cellHeight, "width": controller.cellWidth });
            }
