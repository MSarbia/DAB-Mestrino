...
(function () {
    ...
    * @priority 2
    * @description 
    * An utility directive to display validation messages consistently with the user experience (a warning icon triggering the display of the validation message within a notification tile).
    * 
    * @usage As an element:
    * ``` 
    * <input type='text'
            ...
            link: function (scope, element, attrs, ctrl) {
                ...
                ngModelController.$parsers.unshift(function (viewValue) {
                    ...
                    if (validatorController.validation && typeof validatorController.validation.custom !== 'undefined') {
                        ngModelUpdated = validatorController.validation.custom(viewValue, ngModelController);
                    }

                    if (typeof validatorController.sitChange !== 'undefined') {
                        validatorController.sitChange(ngModelController.$modelValue || ngModelController.$$rawModelValue, viewValue, ngModelUpdated);
                    }
                ...
                ngModelController.$formatters.unshift(function (viewValue) {
                    ...
                    if (!firstLoad && typeof validatorController.sitChange !== 'undefined' && oldViewValue !== viewValue && !isFormatterSitChange) {
                        validatorController.sitChange(oldViewValue, viewValue, ngModelUpdated);
                    }
                ...
                //if (attrs.ngRequired) {
                //        concat += "<div class='validator-required-group-addon input-group-addon' ng-show='" + formController.$name + ".$error.required'>*</div>";
                //}
