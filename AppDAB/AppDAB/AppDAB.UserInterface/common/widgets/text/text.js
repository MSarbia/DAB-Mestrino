...
(function () {
    ...
    *
    * @example
    * The following example shows how to configure a text widget within the sit-data attribute of the {@link siemens.simaticit.common.widgets.propertyGrid sit-property-grid} directive: 
    * ```
    *  {
    *     value: "Text value",
    *     read_only: false,
