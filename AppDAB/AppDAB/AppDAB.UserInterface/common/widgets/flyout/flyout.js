            ...
            link: function (scope, el, attr, ctrl) {
                ...
                flyoutService.getTemplate(ctrl.sitTemplateuri).then(function (popOverContent) {
                    $(el).popover({
                        trigger: 'click',
                        html: true,
                        template: '<div class="popover flyout role="tooltip"><h3 class="popover-title"></h3><div class="popover-content"></div></div>',
...
(function () {
    ...
    * There is no **showFlyout** function because the flyout is an attribute directive. This directive is shown only when the user clicks on the element that contains the directive.
    * 
