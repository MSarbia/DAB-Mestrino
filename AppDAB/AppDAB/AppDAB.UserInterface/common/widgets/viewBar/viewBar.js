...
(function (window) {
    'use strict';
    ViewBarController.$inject = ['$filter'];
    function ViewBarController($filter) {
        var vm = this;
        ...
        function init() {
            ...
            if (vm.options.check.show) {
                vm.selectButton.push(getButtonConfig('fa-check-square-o', vm.options.check.selected, vm.options.check.onClickCallback));
            }
