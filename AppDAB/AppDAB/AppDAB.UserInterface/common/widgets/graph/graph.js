...
(function () {
    ...
    * @property {Object} data Object that contains customized attributes that can be used for configuring nodes. The properties used are: <ul><li>**status**: defines the current node selection status </li></ul>
    * @property {String} icon Optional property that is used to display an icon for each of the nodes. A valid [FontAwesome](http://fortawesome.github.io/Font-Awesome/icons/) CSS class that determines the node icon to be displayed. If not specified, the default icon is displayed.
    ...
    function sitInteractiveGraph($translate, $compile, $timeout, d3, $window) {
        ...
        function GraphController($scope, $element, $compile, fontAwesomIconJson) {
            ...
            function validateGraph() {
                ...
                //if (undefined === vm.graphdata.nodes || 0 === vm.graphdata.nodes.length) {
                //    vm.graphError = $translate.instant('Graph.error.emptyGraph');
                //    vm.isGraphValid = false;
                //    return false;
                //}
        ...
        function GraphUtil(scope, $compile, element, controller) {
            ...
            function drawInteractiveGraph() {
                ...
                var layout;
                //var layout = graphstyle.layout !== undefined ? (graphstyle.layout === "horizontal" ? "LR" : "TB") : "TB";
            ...
            function translateGraph() {
                //selectElement("svg g .output").attr("transform", "translate(" + 0 + ", " + graphTranslateValueY + ")");
            }
            ...
            function slided() {
                ...
                g.attr("transform", "scale(" + (0.25 * scope.zoomLevel) + ")"); //change the scale based on zoomLevel
