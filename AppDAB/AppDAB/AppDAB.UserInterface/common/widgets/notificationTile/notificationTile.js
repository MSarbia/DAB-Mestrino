...
(function () {
    ...
    */
    ...
    NotificationTileController.$inject = ['$scope', '$rootScope', '$element', '$interval', 'common', '$translate', 'LOG_TYPES', 'LOG_LEVELS', 'common.widgets.notificationTile.globalService'];
    function NotificationTileController($scope, $rootScope, $element, $interval, common, $translate, LOG_TYPES, LOG_LEVELS, notificationTileGlobalService) {
        ...
        $scope.$watch(function () {
            ...
            var newValuer;
            if (vm.tileContent)
            { newValuer = vm.tileContent.length > contentCropLength; }
        ...
        function () {
            var newValuer;
            if (vm.tileTitle)
            { newValuer = vm.tileTitle.length > 22; }
                ...
                (function (notificationTile) {
                    ...
                    */
                    var GlobalNotificationService = (function () {
                        function GlobalNotificationService(notificationTileService) {
                    ...
                    GlobalNotificationService.$inject = ['common.widgets.notificationTile.service'];
