...
(function () {
    ...
    *
    * @example
    * The following example shows how to configure a password control in the property-grid, to be used in the data attribute of the {@link siemens.simaticit.common.widgets.propertyGrid} directive:
    * ```
    *  {
    *     read_only: false,
