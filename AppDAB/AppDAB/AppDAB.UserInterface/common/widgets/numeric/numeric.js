...
(function () {
    ...
    *
    * @example
    * The following example shows how to configure a numeric widget within the sit-data attribute of the {@link siemens.simaticit.common.widgets.propertyGrid sit-property-grid} directive:
    * ```
    *  {
    *     value: "0",
    *     read_only: false,
