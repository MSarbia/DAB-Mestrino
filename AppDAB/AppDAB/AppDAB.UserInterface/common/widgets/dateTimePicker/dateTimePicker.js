...
(function () {
    ...
    * @param {String} [sit-format = 'medium'] _(Optional)_ The format in which the selected date is displayed on the widget. Possible values are: fullDate, longDate, mediumDate, shortDate, medium, short.
    ...
    * @param  {Boolean} [sit-show-seconds = false] _(Optional)_ A boolean which specifies whether or not to show the input field for seconds in the time picker.Default value is false.
    * 
    * @example
        ...
        return {
            ...
            link: function (scope, element, attrs, ctrl) {
                ...
                if (element.parents('ng-form[name=filterForm]').length > 0) {
                    ...
                    angular.element($document.find('.canvas-scroll-view')).bind('scroll', setDropdownPosition);
