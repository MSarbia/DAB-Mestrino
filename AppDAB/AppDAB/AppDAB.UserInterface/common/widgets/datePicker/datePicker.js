...
(function () {
    ...
    * 
    * @example
    * The following example shows how to configure a date picker widget within the sit-data attribute of the {@link siemens.simaticit.common.widgets.propertyGrid sit-property-grid} directive:  
    * ```
    *  {
    *     read_only: false,
    *     showButtonBar: false
