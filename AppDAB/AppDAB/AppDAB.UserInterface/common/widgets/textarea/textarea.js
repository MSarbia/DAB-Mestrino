...
(function () {
    ...
    *
    * @example
    * The following example shows how to configure a textarea widget within the sit-data attribute of the {@link siemens.simaticit.common.widgets.propertyGrid sit-property-grid} directive:
    * ```
    *  {
    *     read_only: false,
    *     widget: "sit-textarea",
