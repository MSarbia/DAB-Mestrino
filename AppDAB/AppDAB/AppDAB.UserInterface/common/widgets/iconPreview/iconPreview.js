...
(function () {
   ...
   * @example
   * The following example shows how to configure the sitIcon in the property-grid, to be used in the data attribute of the {@link siemens.simaticit.common.widgets.propertyGrid} directive:
   * ```
   *  {
   *     value: "Icon value",
   *     read_only: false,
