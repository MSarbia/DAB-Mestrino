...
(function () {
    ...
    module.config(['common.services.authentication.configProvider', 'CONFIG', 'APPCONFIG', function (authenticationConfigProvider, CONFIG, APPCONFIG) {       
        ...
        authenticationConfigProvider.config.authorizationServiceUrl =  (config.authorizationServiceUrl) ? config.authorizationServiceUrl : 'http://localhost:9002/OAuth/Authorize';
        authenticationConfigProvider.config.identityProviderUrl =  (config.identityProviderUrl) ? config.identityProviderUrl : 'http://localhost/IPSimatic-Logon';
        ...
        authenticationConfigProvider.config.oDataServiceURI  = (config.engineeringServicesUrl) ? config.engineeringServicesUrl : 'http://localhost:9000/engineering/oData/';
...
(function () {
    ...
    angular.module('siemens.simaticit.common')
        .config(['common.services.runtime.DataConfigProvider','CONFIG','APPCONFIG', function (businessDataConfigProvider, CONFIG, APPCONFIG) {
            ...
            //businessConfigProvider.config.oDataServiceURI= 'http://localhost/odata/';
...
(function () {
    ...
    angular.module('siemens.simaticit.common')
        .config(['common.services.runtime.BusinessDataConfigProvider', 'CONFIG', 'APPCONFIG', function (engineeringBusinessDataConfigProvider, CONFIG, APPCONFIG) {
            ...
            //engineeringDataConfigProvider.config.oDataServiceURI= 'http://localhost/odata/';
...
(function () {
    ...
    angular.module('siemens.simaticit.common')
        .config(['common.services.documentation.configProvider', 'CONFIG', 'APPCONFIG', function (documentationCenterConfigProvider, CONFIG, APPCONFIG) {
            ...
            documentationCenterConfigProvider.config.oDataServiceURI = (config.documentationServicesUrl) ? config.documentationServicesUrl : 'http://localhost:8000/sit-svc/documentation/odata/';
            documentationCenterConfigProvider.config.docCenterUiUrl = (config.documentationCenterUrl) ? config.documentationCenterUrl : 'http://localhost:52082/';
        }]);
...
(function () {
    ...
    function unityExceptionHandler($delegate, logger, LOG_TYPES, $injector) {
        ...
        //var logError = logger.getLogFn('unity', constant.LOG_TYPES.LOG_ERROR);
...
(function () {
    ...
    StateListeners.$inject = ['$rootScope', '$state', '$resolve', '$stateParams', '$location', 'common', 'LOG_TYPES', 'debug', 'CONFIG', 'APPCONFIG',
            'common.services.component.swacComponentManager', 'common.services.security.ui.authorization', '$timeout'];
    function StateListeners($rootScope, $state, $resolve, $stateParams, $location, common, LOG_TYPES, debug, CONFIG, APPCONFIG, swacComponentManager, UIAuthorization) {
        ...
        function activate() {
            ...
            //var logErrorFn = common.logger.getLogFn('StateProvider', LOG_TYPES.LOG_ERROR);
        ...
        function onStateChangeSuccess(event, _toState, _toParams, _fromState, _fromParams) {
            //TODO: add other check and localize the string
