...
(function () {
    ...
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.CreateDatabaseInfoModel', function () {
        function createDatabaseInfoModel(name, description, type, dataModelAssemblyName, datasource, initialCatalog, connectionTimeout, commandTimeout, numberOfRetries, retriesDelay, databaseType, schema) {
            this.name = name;
    ...
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.UpdateDatabaseInfoModel', function () {
        function updateDatabaseInfoModel(name, description, type, dataModelAssemblyName, datasource, initialCatalog, connectionTimeout, commandTimeout, numberOfRetries, retriesDelay, databaseType, schema) {
            this.name = name;
            this.description = description;
            this.type = type;
            this.dataModelAssembly = dataModelAssemblyName;
...
(function () {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').service('common.services.governance.databaseInfoService', ['$q', '$resource', '$injector', '$http', '$translate', 'common', 'CommandResponse', 'ExecutionError', 'common.services.governance.databaseInfoConfig', DatabaseInfoCommands]);
...
(function () {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.addSubscriptionToWorkerRoleResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.removeSubscriptionFromWorkerRoleResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.createEventSubscriptionResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.updateEventSubscriptionResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.deleteEventSubscriptionResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.renameEventSubscriptionResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.addFilterToEventSubscriptionResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.updateFilterInEventSubscriptionResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.removeFilterFromEventSubscriptionResponse', ['CommandResponse', function (CommandResponse) {
...
(function () {
            ...
            if (data) {
                try {
                    ...
                    if (Jsondata.Error) {
                        res = new CommandResponse(Jsondata.Succeeded, new ExecutionError(Jsondata.Error.ErrorCode, Jsondata.Error.ErrorMessage));
                        if (Jsondata.Succeeded && Jsondata.Error.ErrorCode === 0) {
                            common.logger.logInfo(Jsondata.Error.ErrorCode + ' : ' + Jsondata.Error.ErrorMessage, '', 'Event Subscription Command Service');
                        }
                        else {
                            common.logger.logError(Jsondata.Error.ErrorCode + ' : ' + Jsondata.Error.ErrorMessage, '', 'Event Subscription Command Service');
                        }
                    }
                    else {
                        res = new CommandResponse(false, new ExecutionError(Jsondata.error.code, Jsondata.error.message));
                        common.logger.logError(Jsondata.error.code +' : ' + Jsondata.error.message, '', 'Event Subscription Command Service');
                    }
                }
                catch (e) {
                    res = new CommandResponse(false, new ExecutionError(-1, 'Error: ' + e.message));
                    common.logger.logError('-1: Error: ' + e.message, '', 'Event Subscription Command Service');
                }

            } else {
                res = new CommandResponse(false, new ExecutionError(-1, 'Generic Error'));
                common.logger.logError('-1: Error: Generic Error', '', 'Event Subscription Command Service');
            }
        */
            // endregion
            // endregion
         ...
         * @param {object}  common.services.governance.addSubscriptionToWorkerRoleModel  For more information see {@link common.services.governance.addSubscriptionToWorkerRoleModel  common.services.governance.addSubscriptionToWorkerRoleModel} object
         * @returns {object} For more information see {@link common.services.governance.addSubscriptionToWorkerRoleResponse  common.services.governance.addSubscriptionToWorkerRoleResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.removeSubscriptionFromWorkerRoleModel For more information see {@link common.services.governance.removeSubscriptionFromWorkerRoleModel  common.services.governance.removeSubscriptionFromWorkerRoleModel} object
         * @returns {object} For more information see {@link common.governance.removeSubscriptionToWorkerRoleResponse  common.services.governance.removeSubscriptionFromWorkerRoleResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.createEventSubscriptionModel For more information see {@link common.services.governance.createEventSubscriptionModel  common.services.governance.createEventSubscriptionModel} object
         * @returns {object} For more information see {@link common.services.governance.createEventSubscriptionResponse  common.services.governance.createEventSubscriptionResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.updateEventSubscriptionModel For more information see {@link common.services.governance.updateEventSubscriptionModel  common.services.governance.updateEventSubscriptionModel} object
         * @returns {object} For more information see {@link common.services.governance.updateEventSubscriptionResponse  common.services.governance.updateEventSubscriptionResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.deleteEventSubscriptionModel For more information see {@link common.services.governance.deleteEventSubscriptionModel  common.services.governance.deleteEventSubscriptionModel} object
         * @returns {object} For more information see {@link common.services.governance.deleteEventSubscriptionResponse  common.services.governance.deleteEventSubscriptionResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.renameEventSubscriptionModel For more information see {@link common.services.governance.renameEventSubscriptionModel  common.services.governance.renameEventSubscriptionModel} object
         * @returns {object} For more information see {@link common.services.governance.renameEventSubscriptionResponse  common.services.governance.renameEventSubscriptionResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.addFilterToEventSubscriptionModel For more information see {@link common.services.governance.addFilterToEventSubscriptionModel  common.services.governance.addFilterToEventSubscriptionModel} object
         * @returns {object} For more information see {@link common.services.governance.addFilterToEventSubscriptionResponse  common.services.governance.addFilterToEventSubscriptionResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.updateFilterInEventSubscriptionModel For more information see {@link common.services.governance.updateFilterInEventSubscriptionModel  common.services.governance.updateFilterInEventSubscriptionModel} object
         * @returns {object} For more information see {@link common.services.governance.updateFilterInEventSubscriptionResponse  common.services.governance.updateFilterInEventSubscriptionResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.removeFilterFromEventSubscriptionModel For more information see {@link common.services.governance.removeFilterFromEventSubscriptionModel  common.services.governance.removeFilterFromEventSubscriptionModel} object
         * @returns {object} For more information see {@link common.services.governance.removeFilterFromEventSubscriptionResponse  common.services.governance.removeFilterFromEventSubscriptionResponse} object
         *
         * @description
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').service('common.services.governance.eventSubscriptionService', ['$q', '$resource', '$http', '$translate', 'common', 'CommandResponse', 'ExecutionError', 'common.services.governance.eventConfig', eventSubscriptionCommands]);
...
(function () {
    ...
    function projectCommands($q, $resource, $injector, $http, $translate, common, CommandResponse, ExecutionError, projectConfig) {
        ...
        function transformResObj(data) {
            ...
            //    contentType = header["content-type"].split(';')[0];
            //}
            ...
            //    try {
            //        var str = data;
            //        var title = $($.parseXML(str)).find("title").contents();
            //        res = new CommandResponse(false, new ExecutionError(-1, "Server Error: " + title[0].data));
            //    }
            //    catch (ex) {
            //            res = new CommandResponse(false, new ExecutionError(-1, "Server Error: " + ex.message));
            //    }
            //}
         ...
         * @param {object} common.services.governance.loadProjectModel For more information see {@link common.services.governance.loadProjectModel  common.services.governance.loadProjectModel} object
         ...
         * @param {object} common.services.governance.unloadProjectModel For more information see  {@link common.services.governance.unloadProjectModel  common.services.governance.unloadProjectModel} object
         ...
         * @param {object} common.services.governance.deployProjectModel For more information see  {@link common.services.governance.deployProjectModel  common.services.governance.deployProjectModel} object
         * @returns {object} For more information see  {@link common.services.governance.deployProjectResponse  common.services.governance.deployProjectResponse} object
         *
         * @description
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').service('common.services.governance.projectService', ['$q', '$resource', '$injector', '$http', '$translate', 'common', 'CommandResponse', 'ExecutionError', 'common.services.governance.projectConfig', projectCommands]);
...
(function () {
   ...
   */
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').service('common.services.governance.systemEventsService', ['$q', '$resource', '$injector', '$http', '$translate', 'common', 'CommandResponse', 'ExecutionError', 'common.services.governance.systemEventsConfig', systemEventsCommands]);
...
(function () {
     ...
     */
    //angular.module('siemens.simaticit.common.services.governance').factory('common.governance.renameWorkerRoleModel',function(){
    //    /*jshint validthis: true */
    //    function renameWorkerRole(oldName, newName) {
    //        this.oldName = oldName;
    //        this.newName = newName;
    //    }
    //    return renameWorkerRole;
    //});
    ...
    */
     ...
     * @ngdoc type
     * @access internal
     * @name common.governance.renameWorkerRoleResponse
     * @module siemens.simaticit.common.services.governance
     * @requires CommandResponse
     * @description
     * Contains response objects that are used to rename worker role
     *
     */
    /*  angular.module('siemens.simaticit.common.services.governance').factory('common.governance.renameWorkerRoleResponse', ['CommandResponse',function(CommandResponse){
        function renameWorkerRoleResponse() {}
        renameWorkerRoleResponse.prototype = new CommandResponse();
        return renameWorkerRoleResponse;
    }]);*/
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.addWorkerRoleToHostRoleResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.updateWorkerRoleToHostRoleResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.addCommandToWorkerRoleResponse', ['CommandResponse', function (CommandResponse) {
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').factory('common.services.governance.removeCommandFromWorkerRoleResponse', ['CommandResponse',function(CommandResponse){
...
(function () {
    ...
    function WorkerRoleCommands($q, $resource, $http, $translate, common, CommandResponse, ExecutionError, workerRoleConfig) {
        ...
        //function transformRenameDataObj(data){
        //    var jsonData =  {
        //        "OldName": data.oldName,
        //        "NewName": data.newName
        //    };
        ...
        function transformResObj(data) {
            ...
            //        }
            //        else{
            //            msg = "The invoked command probably is not provided by the Service Layer";
            //            res = new CommandResponse(false, new ExecutionError(-1, "Server Error: " + msg));
            //        }
            //    }
            //    catch (ex) {
            //        res = new CommandResponse(false, new ExecutionError(-1, "Server Error: " + ex.message));
        ...
        //function callRenameWorkerRole() {

        //    return $resource('', {}, {
        //        rename: {
        //            method: 'Post',
        //            url: oDataPath + 'RenameWorkerRoleCommand',
        //            transformRequest:[transformRenameDataObj].concat($http.defaults.transformRequest),
        //            transformResponse:[transformResObj].concat($http.defaults.transformResponse)
        //        }
        //    });
        //}
         ...
         * @param {object} common.services.governance.createWorkerRoleModel For more information see {@link common.services.governance.createWorkerRoleModel  common.services.governance.createWorkerRoleModel} object
         ...
         * @param {object} common.services.governance.updateWorkerRoleModel For more information see {@link common.services.governance.updateWorkerRoleModel  common.services.governance.updateWorkerRoleModel} object
         ...
         * @param {object} common.services.governance.deleteWorkerRoleModel For more information see {@link common.services.governance.deleteWorkerRoleModel  common.services.governance.deleteWorkerRoleModel} object
         ...
         * @param {object} common.governance.renameWorkerRoleModel For more information see {@link common.governance.renameWorkerRoleModel  common.governance.renameWorkerRoleModel} object
        ...
        * @param {object} common.services.governance.addCommandsToWorkerRoleModel For more information see {@link common.services.governance.addCommandsToWorkerRoleModel  common.services.governance.addCommandsToWorkerRoleModel} object
        * @returns {object} For more information see {@link common.services.governance.addCommandToWorkerRoleResponse  common.services.governance.addCommandToWorkerRoleResponse} object
        *
        * @description
       ...
       * @param {object} common.services.governance.addCommandsToWorkerRoleModel For more information see {@link common.governance.removeCommandsToWorkerRoleModel  common.services.governance.addCommandsToWorkerRoleModel} object
       ...
       */
         ...
         * @param {object} common.services.governance.addCommandToWorkerRoleModel For more information see {@link common.services.governance.addCommandToWorkerRoleModel  common.services.governance.addCommandToWorkerRoleModel} object
         * @returns {object} For more information see {@link common.services.governance.addCommandToWorkerRoleResponse  common.services.governance.addCommandToWorkerRoleResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.removeCommandFromWorkerRoleModel For more information see {@link common.services.governance.removeCommandFromWorkerRoleModel  common.services.governance.removeCommandFromWorkerRoleModel} object
         * @returns {object} For more information see {@link common.services.governance.removeCommandFromWorkerRoleResponse  common.services.governance.removeCommandFromWorkerRoleResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.addWorkerRoleToHostRoleModel For more information see {@link common.services.governance.addWorkerRoleToHostRoleModel  common.services.governance.addWorkerRoleToHostRoleModel} object
         * @returns {object} For more information see {@link common.services.governance.addWorkerRoleToHostRoleResponse  common.services.governance.addWorkerRoleToHostRoleResponse} object
         *
         * @description
         ...
         * @param {object} common.services.governance.removeWorkerRoleToHostRoleModel For more information see {@link common.services.governance.removeWorkerRoleToHostRoleModel  common.services.governance.removeWorkerRoleToHostRoleModel} object
         ...
         * @param {object} common.services.governance.updateWorkerRoleToHostRoleModel For more information see {@link common.services.governance.updateWorkerRoleToHostRoleModel  common.services.governance.updateWorkerRoleToHostRoleModel} object
         * @returns {object} For more information see {@link common.services.governance.updateWorkerRoleToHostRoleResponse  common.services.governance.updateWorkerRoleToHostRoleResponse} object
         *
         * @description
     ...
     *
     */
    angular.module('siemens.simaticit.common.services.governance').service('common.services.governance.workerRoleService', ['$q', '$resource', '$http', '$translate', 'common', 'CommandResponse', 'ExecutionError', 'common.services.governance.workerRoleConfig', WorkerRoleCommands]);
