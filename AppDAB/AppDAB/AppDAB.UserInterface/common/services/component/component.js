...
(function () {
    ...
    SwacComponentService.$inject = ['common.services.component.swacContainerService', '$timeout', 'common.services.logger.service', '$rootScope'];
    function SwacComponentService(swacContainerService, $timeout, logger, $rootScope) {
        var vm = this;
        var components = {};
        ...
        function onContainerCloseSuccess() {
            ...
            while (0 < pendingComponents.length) {
                createComponent(pendingComponents.pop());
            }
        }
        ...
        function createComponent(component) {
            SWAC.Container.beginCreate([component]).then(
                function (value) {
        ...
        function loadComponent(name, type, source, parent, left, top, width, height, flavor) {
            if (name === undefined || type === undefined || source === undefined || left === undefined || top === undefined || width === undefined || height === undefined || flavor === undefined) {
...
(function () {
    ...
    */
    ...
    function UIComponentService($rootScope, $timeout, $http, $q, logger) {
       ...
       * @param {function} callback The method to be executed when a Mashup component is resized. The new dimensions (width and height) of the component are passed to the callback in an object.
       */
      ...
      * @module siemens.simaticit.common.services.component
      * @description Unregisters a callback method that has been previously registered through the {@link common.services.component.uiComponentService#registerComponentResizeCallback} method.
      * @param {string} componentName Name of the Component.
      ...
      */
        ...
        * @param {function} callback The method to be executed when design mode is enabled or disabled for the current mashup. The Boolean value passed to the callback indicates whether design mode has been enabled (**true**) or disabled (**false**).
        */
        ...
        */
        ...
        function removeComponents(componentList) {
            ...
            for (var index = 0, len = componentList.length; index < len; index++) {
                ...
                //console.log('component to remove.....:' + componentName + ',' + components[componentName]);
                for (var i = 0; i < components[componentName].handlers.length; i++) {
                    components[componentName].handlers[i]();
                }
        ...
        */
        function callComponentFunction(componentName, functionName, args) {
            ...
            return component.instance.hub[functionName].apply(component.instance.hub, args);
        }
        ...
        (function (common) {
            ...
            (function (services) {
                ...
                (function (component) {
                     ...
                     *
                     */
                    var SwacComponentManager = (function () {
                    ...
                    component.SwacComponentManager = SwacComponentManager;
