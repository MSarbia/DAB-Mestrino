(function () {
    'use strict';
    angular.module('Engineering.DAB.AppDAB.SynopticModule').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Engineering.DAB.AppDAB.SynopticModule.SynopticScreen.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/SynopticScreen-select.html',
