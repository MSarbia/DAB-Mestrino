(function () {
    'use strict';
    angular.module('Engineering.DAB.AppDAB.OEEModule').config(AddScreenStateConfig);

    AddScreenController.$inject = ['Engineering.DAB.AppDAB.OEEModule.OEEScreen.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
        ...
        var state = {
            ...
            views: {
                'property-area-container@': {
                    templateUrl: moduleFolder + '/OEEScreen-add.html',
